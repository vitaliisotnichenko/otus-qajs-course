...
Scenario('Add task', async () => {
    I.fillField('#new-todo', 'new task')
    I.pressKey('Enter')
    I.see('new task')
})

Scenario('Move task to complete status', async() => {
    I.fillField('#new-todo', 'new task')
    I.pressKey('Enter')
    I.click('#toggle-all')
    I.see('0 items left')
...
Scenario('Add multiple tasks', async () => {
    I.fillField('#new-todo', 'new task')
    I.pressKey('Enter')
...
Scenario('Use should see new task in "Active" status', async () => {
